...
public abstract class Document {
	...
	{	
		...
		//String text = "if you're single, you've never lost your spouse, and you're not the head of a household, then you pay taxes according to the following table.";
		  ...
		  double f1 = (double)getNumWords() / (double)getNumSentences();
		  double f2 = (double)getNumSyllables() / (double)getNumWords();
		  
			/*
			 * System.out.println("f1 = "+f1+"  and f2 = "+f2);
			 * System.out.println("no of words : "+doc.getNumWords());
			 * System.out.println("no of sentances : "+doc.getNumSentences()); // these all for my understanding
		...
		//return 206.835 - (1.015 * (double)getNumWords()/getNumSentences()) - (84.6 * ((double)getNumSyllables())/getNumWords()); // this also works fine 
	    return Fles;
	}
